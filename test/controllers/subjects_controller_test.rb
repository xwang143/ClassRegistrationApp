...
class SubjectsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create subject" do
    assert_difference('Subject.count') do
      post subjects_url, params: { subject: { abbr: @subject.abbr, name: @subject.name, sub_id: @subject.sub_id } }
    end
  ...
  test "should update subject" do
    patch subject_url(@subject), params: { subject: { abbr: @subject.abbr, name: @subject.name, sub_id: @subject.sub_id } }
